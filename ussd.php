...
if ( $text == "" )
 {
     ...
     if ($text == "1") {$response  = "CON  Pick a table for reservation below \n";
     ...
     // Will be brought to this third menu screenelse if ($text == "1*1") 
     ...
     if ($text == "1*1*1*1")
      {
          ...
          if ($text == "1*1*1*0")
           ...
           // Will be brought to this fourth menu screenelse if ($text == "1*2") 
           {
                   ...
                   else if ($text == "1*2*1*1") 
                   {
                       ...
                       if ($text == "1*2*1*0")
                        ...
                        else if ($text == "1*3*1*0") 
                        {
                            ...
                            if ($text == "1*4*1") {$response = "CON Table for 8 cost -N- 250,000.00 \n";
                            $response .= "Enter 1 to continue \n";$response .= "Enter 0 to cancel";}
                            else if ($text == "1*4*1*1") 
                            {$response = "END Your Table reservation for 8 has been booked";
                            }
                            else if ($text == "1*4*1*0") {$response = "END Your Table reservation for 8 has been canceled";}
                            //
                            echo responseheader('Content-type: text/plain');
                            echo $response?>
